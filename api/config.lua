...
function pfUI:LoadConfig()
  ...
  pfUI:UpdateConfig("panel",      "top",         "left",             "durability")
  pfUI:UpdateConfig("panel",      "top",         "lcenter",          "durability")
  pfUI:UpdateConfig("panel",      "top",         "center",           "durability")
  pfUI:UpdateConfig("panel",      "top",         "rcenter",          "durability")
  pfUI:UpdateConfig("panel",      "top",         "right",            "durability")
