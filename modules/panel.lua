pfUI:RegisterModule("panel", "vanilla:tbc", function()
  ...
  local function setButtonFont(frame, font, font_size, GameFontWhite)
    frame.text:SetFont(font, font_size, "OUTLINE")
    frame.text:SetFontObject(GameFontWhite)
  end

  local function panelCreate(panelname, default_border)
  ...
  local function panelHideCreate(parent, leftright)
  ...
  local function panelHideTexture(parent, framename, leftright)
    SkinButton(parent)
