pfUI:RegisterModule("gui", "vanilla:tbc", function ()
  ...
  do -- Generate Config UI
    ...
    CreateGUIEntry(T["Panel"], nil, function()
      ...
      CreateConfig(nil, T["Top Panel - Left"], C.panel.top, "left", "dropdown", pfUI.gui.dropdowns.panel_values)
      CreateConfig(nil, T["Top Panel - Left Center"], C.panel.top, "lcenter", "dropdown", pfUI.gui.dropdowns.panel_values)
      CreateConfig(nil, T["Top Panel - Center"], C.panel.top, "center", "dropdown", pfUI.gui.dropdowns.panel_values)
      CreateConfig(nil, T["Top Panel - Right Center"], C.panel.top, "rcenter", "dropdown", pfUI.gui.dropdowns.panel_values)
      CreateConfig(nil, T["Top Panel - Right"], C.panel.top, "right", "dropdown", pfUI.gui.dropdowns.panel_values)
